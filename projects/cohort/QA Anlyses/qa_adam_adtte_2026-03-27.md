...
| All paths are relative | ✓ DONE | Lines 44-47, 358. All paths use `cohort/output-data/` (relative). No absolute paths found in code. |
...
**Output dataset:** cohort/output-data/adtte.xpt
...
| file-layout.md | ✓ PASS | Program in cohort/adam_adtte.R, dataset in cohort/output-data/adtte.xpt (matches ADaM pattern) |
