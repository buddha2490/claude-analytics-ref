...
- **Command:** `Rscript -e 'source("cohort/adam_adbs.R", chdir = FALSE)'`
...
- **File:** cohort/output-data/adbs.xpt
...
✓ **PASS** — Lines 39-40: `bs <- haven::read_xpt("cohort/output-data/bs.xpt")` and `dm <- haven::read_xpt("cohort/output-data/dm.xpt")`
...
- All paths use relative format: `cohort/output-data/`
