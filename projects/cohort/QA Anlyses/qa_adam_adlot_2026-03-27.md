...
| All paths are relative (no absolute /Users/... paths) | ✅ PASS | Grep search for `/Users/` returned no matches. All paths are relative (e.g., `cohort/output-data/dm.xpt`). |
...
- [x] ✅ **file-layout.md:** Program in `cohort/`, output in `cohort/output-data/`, correct naming
