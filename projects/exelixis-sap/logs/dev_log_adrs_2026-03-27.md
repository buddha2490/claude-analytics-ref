...
**Program:** projects/exelixis-sap/adam_adrs.R
**Author:** r-clinical-programmer agent
**Date:** 2026-03-27
**Status:** ✓ Complete — validated and saved to projects/exelixis-sap/output-data/adrs.xpt
...
**Files saved:**
- Program: `projects/exelixis-sap/adam_adrs.R`
- Dataset: `projects/exelixis-sap/output-data/adrs.xpt` (184 rows, 13 variables)
...
1. **Confirmed response logic (R3):** The BOR derivation implements the SAP requirement for ≥28-day confirmation. Code comment references `projects/exelixis-sap/artifacts/Open-questions-cdisc.md R3`.

2. **AVAL coding (R8):** The numeric coding 1=CR through 5=NE is study-specific and intentional per NPM-008 analysis plan. Code comment references `projects/exelixis-sap/artifacts/Open-questions-cdisc.md R8`.
