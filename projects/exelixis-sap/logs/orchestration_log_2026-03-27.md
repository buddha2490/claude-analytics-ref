...
- **Variables:** 10
- **Program:** projects/exelixis-sap/adam_adlot.R
- **Dataset:** projects/exelixis-sap/output-data/adlot.xpt
...
- **Program:** projects/exelixis-sap/adam_adsl.R
- **Dataset:** projects/exelixis-sap/output-data/adsl.xpt
...
- **Dataset:** projects/exelixis-sap/output-data/adrs.xpt
...
- **Dataset:** projects/exelixis-sap/output-data/adae.xpt
...
- **Dataset:** projects/exelixis-sap/output-data/adtte.xpt
