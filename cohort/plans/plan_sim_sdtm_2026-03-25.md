...
- [ ] **haven::write_xpt()**: write to `cohort/output-data/sdtm/<domain>.xpt` in lowercase
...
Create `cohort/` directory and `cohort/output-data/sdtm/` directory. Install packages: `haven`, `xportr`, `tidyverse`.
...
6. Write XPT via `haven::write_xpt(domain_df, path = "cohort/output-data/sdtm/<domain>.xpt")`
...
- All 18 XPT files exist in `cohort/output-data/sdtm/`
