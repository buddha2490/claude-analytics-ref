...
**Source domains:** 18 SDTM domains (XPT files in `cohort/output-data/sdtm/`)
...
- Dependency datasets (read SDTM from `cohort/output-data/sdtm/`, ADaM from `cohort/output-data/adam/`)
...
```r
# =============================================================================
# Program: cohort/programs/adam_<dataset>.R
...
adsl_demo <- dm %>% ...
saveRDS(adsl_demo, "cohort/output-data/adam/.adsl_checkpoint_demo.rds")

# --- Biomarker block → save checkpoint ---
adsl_bio <- adsl_demo %>% left_join(...) %>% ...
saveRDS(adsl_bio, "cohort/output-data/adam/.adsl_checkpoint_bio.rds")
...
```r
# Save dataset
haven::write_xpt(<dataset>, "cohort/output-data/<dataset>.xpt")
```

Save the final R program to: `cohort/programs/adam_<dataset>.R`
Save the dev log to: `cohort/logs/dev_log_<dataset>_2026-03-27.md`
...
**Path convention:** All file paths must be relative to the project root. Never use absolute paths (e.g., `/Users/.../cohort/output-data/`). SDTM domains are in `cohort/output-data/sdtm/` (e.g., `cohort/output-data/sdtm/dm.xpt`). ADaM datasets are in `cohort/output-data/adam/` (e.g., `cohort/output-data/adam/adsl.xpt`). Programs are executed from the project root directory.
...
2. Read the implemented program at `cohort/programs/adam_<dataset>.R`
3. Read the dev log at `cohort/logs/dev_log_<dataset>_2026-03-27.md`
...
1. Source the program: `source("cohort/programs/adam_<dataset>.R", chdir = FALSE)`
...
Each `r-clinical-programmer` agent must maintain a log at `cohort/logs/dev_log_<dataset>_2026-03-27.md`:
...
The orchestrator (main conversation) must maintain a running log at `cohort/logs/orchestration_log_2026-03-27.md` that captures the full workflow. This log is the primary artifact for evaluating the end-to-end process after completion.
...
- **Program:** cohort/programs/adam_adlot.R
- **Dataset:** cohort/output-data/adam/adlot.xpt
...
for (d in required_domains) {
  f <- file.path("cohort/output-data/sdtm", paste0(d, ".xpt"))
...
**After pre-flight passes:** Create the orchestration log file at `cohort/logs/orchestration_log_2026-03-27.md` with the pre-flight results. Append to this log after each wave completes (see Section 7, Orchestration Log template).
...
datasets <- list.files("cohort/output-data/adam", pattern = "^ad.*\\.xpt$", full.names = TRUE)
dm <- haven::read_xpt("cohort/output-data/sdtm/dm.xpt")
...
|------|-------|-------|--------|
| 1a. Implement ADLOT | `r-clinical-programmer` | This plan (Section 4.1) | `cohort/programs/adam_adlot.R`, `cohort/output-data/adam/adlot.xpt`, `cohort/logs/dev_log_adlot_2026-03-27.md` |
| 1b. Implement ADBS | `r-clinical-programmer` | This plan (Section 4.2) | `cohort/programs/adam_adbs.R`, `cohort/output-data/adam/adbs.xpt`, `cohort/logs/dev_log_adbs_2026-03-27.md` |

**Wave 1 QC — Spawn after 1a/1b complete:**

| Task | Agent | Input | Output |
|------|-------|-------|--------|
| 1c. QC ADLOT | `clinical-code-reviewer` | Plan + `cohort/programs/adam_adlot.R` + dev log | `QA reviews/qa_adam_adlot_2026-03-27.md` |
| 1d. QC ADBS | `clinical-code-reviewer` | Plan + `cohort/programs/adam_adbs.R` + dev log | `QA reviews/qa_adam_adbs_2026-03-27.md` |
...
| Task | Agent | Input | Output |
|------|-------|-------|--------|
| 2a. Implement ADSL | `r-clinical-programmer` | This plan (Section 4.3) + `cohort/output-data/adam/adlot.xpt` | `cohort/programs/adam_adsl.R`, `cohort/output-data/adam/adsl.xpt`, `cohort/logs/dev_log_adsl_2026-03-27.md` |

**Wave 2 QC:**

| Task | Agent | Input | Output |
|------|-------|-------|--------|
| 2b. QC ADSL | `clinical-code-reviewer` | Plan + `cohort/programs/adam_adsl.R` + dev log | `QA reviews/qa_adam_adsl_2026-03-27.md` |
...
| Task | Agent | Input | Output |
|------|-------|-------|--------|
| 3a. Implement ADRS | `r-clinical-programmer` | This plan (Section 4.4) + `cohort/output-data/adam/adsl.xpt` | `cohort/programs/adam_adrs.R`, `cohort/output-data/adam/adrs.xpt`, `cohort/logs/dev_log_adrs_2026-03-27.md` |
| 3b. Implement ADAE | `r-clinical-programmer` | This plan (Section 4.5) + `cohort/output-data/adam/adsl.xpt` | `cohort/programs/adam_adae.R`, `cohort/output-data/adam/adae.xpt`, `cohort/logs/dev_log_adae_2026-03-27.md` |

**Wave 3 QC:**

| Task | Agent | Input | Output |
|------|-------|-------|--------|
| 3c. QC ADRS | `clinical-code-reviewer` | Plan + `cohort/programs/adam_adrs.R` + dev log | `QA reviews/qa_adam_adrs_2026-03-27.md` |
| 3d. QC ADAE | `clinical-code-reviewer` | Plan + `cohort/programs/adam_adae.R` + dev log | `QA reviews/qa_adam_adae_2026-03-27.md` |
...
| Task | Agent | Input | Output |
|------|-------|-------|--------|
| 4a. Implement ADTTE | `r-clinical-programmer` | This plan (Section 4.6) + `cohort/output-data/adam/adsl.xpt` + `cohort/output-data/adam/adrs.xpt` | `cohort/programs/adam_adtte.R`, `cohort/output-data/adam/adtte.xpt`, `cohort/logs/dev_log_adtte_2026-03-27.md` |

**Wave 4 QC:**

| Task | Agent | Input | Output |
|------|-------|-------|--------|
| 4b. QC ADTTE | `clinical-code-reviewer` | Plan + `cohort/programs/adam_adtte.R` + dev log | `QA reviews/qa_adam_adtte_2026-03-27.md` |
...
Save program to: cohort/programs/adam_<dataset>.R
Save dataset to: cohort/output-data/adam/<dataset>.xpt
Save dev log to: cohort/logs/dev_log_<dataset>_2026-03-27.md
```
...
and the "Global Conventions" subsection at the end of Section 5.
Read the program at: cohort/programs/adam_<dataset>.R
Read the dev log at: cohort/logs/dev_log_<dataset>_2026-03-27.md
...
|------|------|------------|
| **Programs** | | |
| ADLOT program | `cohort/programs/adam_adlot.R` | r-clinical-programmer |
| ADBS program | `cohort/programs/adam_adbs.R` | r-clinical-programmer |
| ADSL program | `cohort/programs/adam_adsl.R` | r-clinical-programmer |
| ADRS program | `cohort/programs/adam_adrs.R` | r-clinical-programmer |
| ADAE program | `cohort/programs/adam_adae.R` | r-clinical-programmer |
| ADTTE program | `cohort/programs/adam_adtte.R` | r-clinical-programmer |
| **Datasets** | | |
| ADLOT | `cohort/output-data/adam/adlot.xpt` | r-clinical-programmer |
| ADBS | `cohort/output-data/adam/adbs.xpt` | r-clinical-programmer |
| ADSL | `cohort/output-data/adam/adsl.xpt` | r-clinical-programmer |
| ADRS | `cohort/output-data/adam/adrs.xpt` | r-clinical-programmer |
| ADAE | `cohort/output-data/adam/adae.xpt` | r-clinical-programmer |
| ADTTE | `cohort/output-data/adam/adtte.xpt` | r-clinical-programmer |
| **Dev Logs** | | |
| ADLOT log | `cohort/logs/dev_log_adlot_2026-03-27.md` | r-clinical-programmer |
| ADBS log | `cohort/logs/dev_log_adbs_2026-03-27.md` | r-clinical-programmer |
| ADSL log | `cohort/logs/dev_log_adsl_2026-03-27.md` | r-clinical-programmer |
| ADRS log | `cohort/logs/dev_log_adrs_2026-03-27.md` | r-clinical-programmer |
| ADAE log | `cohort/logs/dev_log_adae_2026-03-27.md` | r-clinical-programmer |
| ADTTE log | `cohort/logs/dev_log_adtte_2026-03-27.md` | r-clinical-programmer |
| **QA Reports** | | |
...
| **Orchestration Log** | | |
| Workflow log | `cohort/logs/orchestration_log_2026-03-27.md` | orchestrator (main conversation) |
...
| ~~13~~ | ~~`cohort/logs/` directory does not exist~~ — **RESOLVED:** Pre-flight validation and Step 1 now create `cohort/logs/` and `QA reviews/` directories automatically. | All |
