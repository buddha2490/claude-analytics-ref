...
| `ads-data` | Pulling, loading, exploring, or subsetting ADS data | `get_ads()` usage, enriched vs essentials, tumor cohorts, nested JSON columns, subsetting patterns |
| `cohort-cascade` | Building exclusion criteria / attrition tables | `df → df1/df2/... → cohort` cascade pattern with cumulative exclusion flags |
